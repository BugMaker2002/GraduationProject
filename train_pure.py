...
result_dir = './results/pure/physformer'  # store checkpoints and training recording

# define the dataloader
train_dataset = PUREDataset(train=True, vid_frame=T)  # please read the code about H5Dataset when preparing your dataset
...
val_dataset = PUREDataset(train=False, vid_frame=T)  # please read the code about H5Dataset when preparing your dataset
...
# plt.tight_layout()
# # 将图表保存为图片文件
# plt.savefig('training_and_validation_loss_plots_pure.png')
# # 显示图表
# plt.show()